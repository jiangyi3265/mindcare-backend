...
create table mc_record (
  ...
  risk_level       varchar(20)   default 'normal'        comment '测评风险等级',
  risk_reason      varchar(255)  default ''              comment '测评风险说明',
  handling_method  varchar(30)   default null             comment '后台处理方式',
  handling_note    varchar(500)  default null             comment '后台处理备注',
  handling_time    datetime      default null             comment '后台处理时间',
  create_time      datetime                              comment '创建时间',
...
(2009, '咨询专家', 2000, 5, 'experts', 'mindcare/content/expert', null, 'MindcareExperts', 1, 0, 'C', '0', '0', 'mindcare:content:list', 'user', 'admin', sysdate(), '', null, '咨询专家资料管理'),
