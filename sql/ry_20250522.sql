...
-- 初始管理员使用随机且不可恢复的密码哈希；首次部署后请通过安全流程重置密码
insert into sys_user values(1, 101, 'admin', '管理员', '00', 'admin@qq.com', '15888888888', '1', '', '$2b$12$TE3zjVKSPXyjefw5Tk9XruUB7cCbmLHtSV.ODaqW62yN24KW.yGX.', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '超级管理员');
...
insert into sys_config values(2, '用户管理-账号初始密码',      'sys.user.initPassword',         '',           'Y', 'admin', sysdate(), '', null, '首次部署后请通过安全渠道配置初始密码策略');
